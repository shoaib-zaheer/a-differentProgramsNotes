...
function Snake(){
 ...
 ```
Every time you press the mouse it will act like the snake is eating the food.
...
function mousePressed(){
  s.total++; // mean every time we press the mouse it act like snake is eating food
}
...
function Snake(){
 ...
 ```
[Read More...](https://www.youtube.com/watch?v=AaGK-fj-BAM)